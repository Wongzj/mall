<template>
  <el-card class="account-container">
    <el-form :model="nameForm" :rules="rules" ref="nameRef" label-width="80px" label-position="right" class="demo-ruleForm">
      ...
      <el-form-item>
        <el-button type="danger" @click="submitName">Confirm Modification</el-button>
      </el-form-item>
    </el-form>
  </el-card>
  <el-card class="account-container">
    <el-form :model="passForm" :rules="rules" ref="passRef" label-width="80px" label-position="right" class="demo-ruleForm">
      ...
      <el-form-item>
        <el-button type="danger" @click="submitPass">Confirm Modification</el-button>
      </el-form-item>
    </el-form>
  </el-card>
</template>
  ...
  setup() {
    ...
    const state = reactive({
      ...
      rules: {
        ...
        nickName: [
          { required: 'true', message: 'Nick name cannot be empty', trigger: ['change'] }
        ],
        oldpass: [
      ...
      nameRef.value.validate((vaild) => {
        if (vaild) {
          axios.put('/adminUser/name', {
            ...
            ElMessage.success('Modification succeeded')
