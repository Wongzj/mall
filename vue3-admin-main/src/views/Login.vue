  ...
  <div class="login-body">
    <div class="login-container">
      <div class="head">
        ...
        <div class="name">
          <div class="title">Pet Kingdom Mall</div>
          <div class="tips">Background Management System</div>
        </div>
      </div>
      <el-form label-position="top" :rules="rules" :model="ruleForm" ref="loginForm" class="login-form">
        ...
        <el-form-item>
          <div style="color: #333">By logging in you agree<a>"Terms of Service"</a></div>
          <el-button style="width: 100%" type="primary" @click="submitForm">Log in immediately</el-button>
