...
public class EsProductController {
    ...
    @ApiOperation(value = "Import all products in the database to es")
    ...
    @ApiOperation(value = "Delete products in batch according to ID")
    ...
    @ApiOperation(value = "Create item by ID")
    ...
    @ApiOperation(value = "Recommend products according to product ID")
    ...
    @ApiOperation(value = "Get relevant brands, classifications and filtering attributes of search")
