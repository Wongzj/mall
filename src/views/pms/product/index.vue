<template> 
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      <div>You can only add up to three:
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Put on sale status:">
      ...
      <el-table ref="productTable"
        ...
        <el-table-column label="Price/Item No." width="120" align="center">
          <template slot-scope="scope">
            ...
            <p>Goods number:{{scope.row.productSn}}</p>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleEditSkuConfirm(){
        ...
        this.$confirm('Do you want to make changes', 'Hint', {
      ...
      handleBatchOperate() {
        ...
        if(this.multipleSelection==null||this.multipleSelection.length<1){
          this.$message({
            message: 'Please select the item you want to operate',
            type: 'warning',
            duration: 1000
          });
          return;
        }
        this.$confirm('Do you want to perform this bulk operation?', 'Hint', {
          confirmButtonText: 'OK',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
