      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">Total selling orders today</div>
        ...
        <el-col :span="6">
          <div class="total-frame">
            ...
            <div class="total-title">Total orders yesterday</div>
            <div class="total-value">￥5000.00</div>
          </div>
        </el-col>
    ...
    <div class="un-handle-layout">
      ...
      <div class="un-handle-content">
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">To be confirmed receipt Order</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">To be delivered order</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="out-border">
            <div class="layout-title">Goods overview</div>
            <div style="padding: 40px">
              ...
              <el-row class="font-medium">
                <el-col :span="6" class="overview-item-title">Has been removed</el-col>
                <el-col :span="6" class="overview-item-title">Already put on sale</el-col>
                <el-col :span="6" class="overview-item-title">Inventory is tight</el-col>
          ...
          <div class="out-border">
            ...
            <div style="padding: 40px">
              ...
              <el-row class="font-medium">
                ...
                <el-col :span="6" class="overview-item-title">Added this month</el-col>
                <el-col :span="6" class="overview-item-title">Total number of member</el-col>
              </el-row>
            </div>
          </div>
        </el-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        labelMap: {'orderCount': 'Number of order', 'orderAmount': 'Order amount'}},
        chartData: {
          columns: [],
          rows: []
        },
