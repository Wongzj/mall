  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="roleTable"
        ...
        <el-table-column label="Enable or not" width="140" align="center">
  ...
  export default {
    ...
    methods: {
      ...
      handleStatusChange(index, row) {
        this.$confirm('Do you want to change this state?', 'Hint', {
          ...
          this.$message({
            type: 'info',
            message: 'Cancel modified'
          });
          this.getList();
        });
      },
      handleDelete(index, row) {
        this.$confirm('Whether to delete the character?', 'Hint', {
          confirmButtonText: 'OK',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
