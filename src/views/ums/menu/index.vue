  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="menuTable"
        ...
        <el-table-column label="Menu series" width="100" align="center">
        ...
        <el-table-column label="To show or not" width="100" align="center">
        ...
        <el-table-column label="Setting" width="120" align="center">
          <template slot-scope="scope">
            <el-button
              ...
              @click="handleShowNextLevel(scope.$index, scope.row)">Check lower menu
            </el-button>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(index, row) {
        this.$confirm('Whether to delete the menu', 'Hint', {
