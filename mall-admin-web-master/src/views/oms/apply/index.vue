  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="Handle status:">
          ...
          <el-form-item label="Handle time:">
            <el-date-picker
              class="input-width"
    ...
    <div class="table-container">
      <el-table ref="returnApplyTable"
        ...
        <el-table-column label="Handle time" width="180" align="center">
        ...
        <el-table-column label="Operate" width="180" align="center">
          <template slot-scope="scope">
            <el-button
            size="mini"
            @click="handleViewDetail(scope.$index, scope.row)">Check the details</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
