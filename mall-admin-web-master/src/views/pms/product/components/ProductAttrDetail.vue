    ...
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      <el-form-item label="Property type:">
        <el-select v-model="value.productAttributeCategoryId"
                   placeholder="Please chose a property type"
      ...
      <el-form-item label="Product specifications:">
        ...
        <el-button
          ...
          @click="handleRefreshProductSkuList">Refresh Url
        </el-button>
        <el-button
          type="primary"
          style="margin-top: 20px"
        ...
        <el-button
          type="primary"
          style="margin-top: 20px"
          @click="handleSyncProductSkuStock">Synchronized stocks
        </el-button>
      </el-form-item>
      ...
      <el-form-item label="Goods attribute:">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item label="Specifications parameter:">
      ...
      <el-form-item style="text-align: center">
        <el-button size="medium" @click="handlePrev">In the previous step, fill in the product promotion</el-button>
  ...
  export default {
    ...
    methods: {
      ...
      handleRefreshProductSkuList() {
        this.$confirm('Refreshing the list will cause the sku information to be regenerated, do you want to refresh', 'Hint', {
      ...
      handleSyncProductSkuPrice(){
        this.$confirm('Will sync the price of the first sku to all sku, whether to continue', 'Hint', {
          confirmButtonText: 'OK',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      handleSyncProductSkuStock(){
        this.$confirm('Will sync the inventory of the first sku to all sku, continue or not', 'Hint', {
          confirmButtonText: 'OK',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
