...
public class UmsMemberLevel implements Serializable {
    ...
    @ApiModelProperty(value = "Default Status: 0->NO;1->YES")
    private Integer defaultStatus;

    @ApiModelProperty(value = "Free Freight Standard")
    private BigDecimal freeFreightPoint;

    @ApiModelProperty(value = "Comment Growth Point")
    private Integer commentGrowthPoint;

    @ApiModelProperty(value = "Priviledge Free Freight")
    private Integer priviledgeFreeFreight;

    @ApiModelProperty(value = "Priviledge Sign In")
    private Integer priviledgeSignIn;

    @ApiModelProperty(value = "Priviledge Comment")
    private Integer priviledgeComment;

    @ApiModelProperty(value = "Priviledge Promotion")
    private Integer priviledgePromotion;

    @ApiModelProperty(value = "Priviledge Member Price")
    private Integer priviledgeMemberPrice;

    @ApiModelProperty(value = "Priviledge Birthday")
