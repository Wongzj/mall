...
public class OmsOrderReturnApply implements Serializable {
    ...
    @ApiModelProperty(value = "status：0->Pending；1->Returning；2->Finished；3->Refused")
    ...
    @ApiModelProperty(value = "Product Attribute：Color：red；Size：XL;")
    private String productAttr;

    @ApiModelProperty(value = "Returned Product Count")
    private Integer productCount;

    @ApiModelProperty(value = "Product Price")
    private BigDecimal productPrice;

    @ApiModelProperty(value = "Product Real Price")
    ...
    @ApiModelProperty(value = "Proof Pics")
    private String proofPics;

    @ApiModelProperty(value = "Handled Note")
    private String handleNote;

    @ApiModelProperty(value = "Handle Man")
