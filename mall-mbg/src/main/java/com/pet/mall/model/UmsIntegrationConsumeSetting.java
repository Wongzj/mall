...
public class UmsIntegrationConsumeSetting implements Serializable {
    ...
    @ApiModelProperty(value = "Deduction Per Amount")
    private Integer deductionPerAmount;

    @ApiModelProperty(value = "Max Percent Per Order")
    private Integer maxPercentPerOrder;

    @ApiModelProperty(value = "Use Min Unit(100)")
    private Integer useUnit;

    @ApiModelProperty(value = "Use with Coupon；0->NO;1->YES")
