...
<template>
  <div class="product-detail">
    ...
    <van-goods-action>
      ...
      <van-goods-action-icon icon="cart-o" :info="!count ? '' : count" @click="goTo()" text="Shopping cart"/>
...
export default {
  ...
  methods: {
    ...
    async addCart() {
      const { data, resultCode } = await addCart({ goodsCount: 1, goodsId: this.detail.id })
