  ...
  <div>
    ...
    <div class="good">
      ...
      <div class="good-box">
        ...
        <div class="good-item" v-for="item in newGoodses" :key="item.id" @click="goToDetail(item)">
          <img :src="prefix(item.pic)" alt="">
          <div class="good-desc">
    ...
    <div class="good">
      ...
      <div class="good-box">
        ...
        <div class="good-item" v-for="item in hots" :key="item.id" @click="goToDetail(item)">
          <img :src="prefix(item.pic)" alt="">
          <div class="good-desc">
            <div class="title">{{ item.name }}</div>
            <div class="price">¥ {{ item.price }}</div>
    ...
    <div class="good" :style="{ paddingBottom: '100px'}">
      ...
      <div class="good-box">
        ...
        <div class="good-item" v-for="item in recommends" :key="item.id" @click="goToDetail(item)">
          <img :src="prefix(item.pic)" alt="">
          <div class="good-desc">
            <div class="title">{{ item.name }}</div>
            <div class="price">¥ {{ item.price }}</div>
...
export default {
  ...
  async mounted() {
    ...
    this.newGoodses = data.newProductList
    // this.hots = data.hotGoodses
    this.hots = data.hotProductList
    // this.recommends = data.recommendGoodses
    this.recommends = data.advertiseList
    Toast.clear()
  },
  methods: {
    pageScroll() {
