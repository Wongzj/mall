...
<template>
  <div class="order-box">
    ...
    <van-tabs @change="onChangeTab" :color="'#c92222'" :title-active-color="'#c92222'" class="order-tab" v-model="status">
      ...
      <van-tab title="Shipped" name="3"></van-tab>
      <van-tab title="Transaction complete" name="4"></van-tab>
    </van-tabs>
