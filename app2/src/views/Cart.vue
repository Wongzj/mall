...
<template>
  <div class="cart-box">
    ...
    <van-submit-bar
      ...
      @submit="onSubmit"
    >
      <van-checkbox @click="allCheck" v-model="checkAll">Select all</van-checkbox>
    </van-submit-bar>
    <div class="empty" v-if="!list.length">
      <van-icon name="smile-o" />
      <div class="title">Empty shopping cart</div>
      <van-button color="#c92222" type="primary" @click="goTo" block>Go to menu</van-button>
    </div>
    <nav-bar></nav-bar>
  </div>
</template>
