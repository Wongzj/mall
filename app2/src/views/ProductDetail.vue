...
<template>
  <div class="product-detail">
    <s-header :name="'Goods details'"></s-header>
    <div class="detail-content">
      <div class="detail-swipe-wrap">
        <van-swipe class="my-swipe" indicator-color="#c92222">
      ...
      <div class="product-info">
        ...
        <div class="product-desc">Free postage</div>
    ...
    <van-goods-action>
      ...
      <van-goods-action-button type="warning" @click="addCart" text="Add to shopping cart" />
...
<style lang="less">
  ...
  .product-detail {
    ...
    .van-goods-action-button--warning {
      background: linear-gradient(to right,#f96060, @primary)
    }
    .van-goods-action-button--danger {
      background: linear-gradient(to right, #f64646, #b50d0d)
    }
  }
</style>
