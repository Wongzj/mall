...
<template>
  <div class="create-order">
    ...
    <div class="pay-wrap">
      ...
      <van-button @click="createOrder" class="pay-btn" color="#c92222" type="primary" block>Generate orders</van-button>
    </div>
    <van-popup
      closeable
    ...
    >
      <div :style="{ width: '90%', margin: '0 auto', padding: '50px 0' }">
        <van-button :style="{ marginBottom: '10px' }" color="#c92222" block @click="payOrder(1)">Pay by AliPay</van-button>
        <van-button color="#c92222" block @click="payOrder(2)">Pay by Wechat Pay</van-button>
      </div>
    </van-popup>
  </div>
</template>
